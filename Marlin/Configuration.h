...
#define STRING_CONFIG_H_AUTHOR "(mlee12382, just-trey, Elegoo Neptune 2)" // Who made the changes.
...
// - NOTE: only works on 1.2 board - manual rename to elegoo.bin is needed for 1.3 board
...
// For ZNP Robin Nano 1.2 - set default_envs = mks_robin_nano35 & use PlatformIO: Build to compile.
...
// Usually paired with MKS Robin Nano V1.2
//
#define MKS_ROBIN_TFT35  //mlee12382
...
//
//#define TFT_GENERIC //just-trey
#if ENABLED(TFT_GENERIC)
  // :[ 'AUTO', 'ST7735', 'ST7789', 'ST7796', 'R61505', 'ILI9328', 'ILI9341', 'ILI9488' ]
  #define TFT_DRIVER ILI9341

  // Interface. Enable one of the following options:
  //#define TFT_INTERFACE_FSMC //just-trey
  //#define TFT_INTERFACE_SPI

  // TFT Resolution. Enable one of the following options:
  //#define TFT_RES_320x240
  //#define TFT_RES_480x272
  //#define TFT_RES_480x320 //just-trey
